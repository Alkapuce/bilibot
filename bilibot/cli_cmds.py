...
def _settings_from_args(args: argparse.Namespace) -> Settings:
    return load_settings(
        ...
        llm_fallback_models=args.llm_fallback_models,
        llm_model_providers=args.llm_model_providers,
        llm_provider_base_urls=args.llm_provider_base_urls,
        llm_provider_api_keys=args.llm_provider_api_keys,
        ...
        summary_max_single_chunk_chars=args.summary_max_single_chunk_chars,
