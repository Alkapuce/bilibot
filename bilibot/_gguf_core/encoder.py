...
class QwenAudioEncoder:
    ...
    def __init__(self, frontend_path: str, backend_path: str, use_dml: bool = True, pad_to: int = 30, verbose: bool = True):
        ...
        if self.verbose: 
            logger.info(f"--- [Encoder] 加载 Split ONNX 模型 (DML: {self.active_dml}, Pad: {pad_to}s) ---")
